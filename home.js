...
console.log("greetuser('Amit'):", greetUser('Amit'))
...
//CODE HERE
const canDeliverString = "You're in our delivery zone!"
const cannotDeliverString = "Sorry, we can't deliver to that address"
const canWeDeliver = (zipCode) => 
    deliveryAreaZipCodes.includes(zipCode) ? canDeliverString : cannotDeliverString

console.log("canWeDeliver(30305):", canWeDeliver(30305))
console.log("canWeDeliver(85203):", canWeDeliver(85203))
...
const canWeDeliverTwo = (zipCode) => {
    for(let i=0; i < deliveryAreaZipCodes.length; i++){
        if(deliveryAreaZipCodes[i] === zipCode){
            return canDeliverString
        }
    }
    return cannotDeliverString
}
console.log("canWeDeliverTwo(30305):", canWeDeliverTwo(30305))
console.log("canWeDeliverTwo(85203):", canWeDeliverTwo(85203))
...
//CODE HERE
console.log("deals before:", deals)
deals[0].title = deals[0].title.replace("15","10")
console.log("deals after:", deals)
